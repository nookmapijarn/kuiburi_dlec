...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="รายงานสถิตินักศึกษา สกร.อำเภอกุยบุรี">
        <meta name="robots" content="รายงานสถิตินักศึกษา สกร.อำเภอกุยบุรี">
        <title>{{ config('app.name', 'ผู้บริหาร-สกร.อำเภอกุยบุรี') }}</title>
